...
{
    public partial interface IFoldersEndpoint : IXeroUpdateEndpoint<FoldersEndpoint, Model.Folder, FolderRequest, FolderResponse>
    {
    ...
    public partial class FoldersEndpoint : XeroUpdateEndpoint<FoldersEndpoint, Model.Folder, FolderRequest, FolderResponse>, IFoldersEndpoint
    {
        ...
        public override IEnumerable<Model.Folder> Find()
        {
            var response = HandleFoldersResponse(Client.Client.Get("files.xro/1.0/Folders", String.Empty));
