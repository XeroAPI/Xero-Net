...
{
    public interface ILinkedTransactionsEndpoint : IXeroUpdateEndpoint<ILinkedTransactionsEndpoint, LinkedTransaction, LinkedTransactionsRequest, LinkedTransactionsResponse>, IPageableEndpoint<ILinkedTransactionsEndpoint>
    {
    ...
    public class LinkedTransactionsEndpoint
        : XeroUpdateEndpoint<ILinkedTransactionsEndpoint, LinkedTransaction, LinkedTransactionsRequest, LinkedTransactionsResponse>, ILinkedTransactionsEndpoint
    {
