...
namespace Xero.Api.Core.Endpoints.Base
{
    ...
    {
        Task<IList<TResult>> UpdateAsync(IList<TResult> items, CancellationToken cancellation = default(CancellationToken));

        Task<TResult> UpdateAsync(TResult item, CancellationToken cancellation = default(CancellationToken));
    }
}
